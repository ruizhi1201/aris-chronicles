...
Devon pressed a button. Not in Slack — in a separate terminal window, something running on his machine. A script.
...
Devon pulled up the setup documentation on another tab. "Okay," he said. "So you'll need an account — you probably already have one from the trial. Then you connect it to your tools. For me that was Slack and our support queue, but you can connect it to basically anything with an API. Then you define the agent's behavior in a system prompt. That's where it gets — " he paused, searching for the right word. "That's where it gets specific."

"How specific?"

"You're describing a job to someone who will do exactly what you say and nothing you don't say. So you have to be precise. You have to think about edge cases. You have to think about what happens when the input is ambiguous." He scrolled through his own system prompt — Kai could see dense paragraphs of instructions, conditional logic written in plain English. "I went through four versions of this before it stopped doing weird things."
...
He thought: I need to name this before I can talk to it. This is a thing he'd learned in product work — you couldn't design for a user you hadn't imagined clearly enough to name. The naming wasn't the point, but without it you were designing for fog.
...
*Orion. (He tested it — Orion, what can you do? — and felt nothing.)*
